...
class ExpensePieProviderTest {
    ...
    @InjectMocks
    private ExpensePieProvider provider;

    @Test
    @DisplayName("returns EXPENSE_PIE as the supported widget type")
    void getSupportedType_returnsExpensePie() {
        assertThat(provider.getSupportedType()).isEqualTo(StatisticsWidgetType.EXPENSE_PIE);
    }
    ...
    void getData_withResults() {
        ...
        DistributionPayload expected = new DistributionPayload(StatisticsWidgetType.EXPENSE_PIE, List.of());

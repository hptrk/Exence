...
class ExpenseCategoryColumnProviderTest {
    ...
    @InjectMocks
    private ExpenseCategoryColumnProvider provider;

    @Test
    @DisplayName("returns EXPENSE_CATEGORY_COLUMN as the supported widget type")
    void getSupportedType_returnsExpenseCategoryColumn() {
        assertThat(provider.getSupportedType()).isEqualTo(StatisticsWidgetType.EXPENSE_CATEGORY_COLUMN);
    }
    ...
    void getData_withResults() {
        ...
        SeriesPayload expected = new SeriesPayload(StatisticsWidgetType.EXPENSE_CATEGORY_COLUMN, List.of());

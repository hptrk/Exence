...
class IncomeCategoryTrendProviderTest {
    ...
    @InjectMocks
    private IncomeCategoryTrendProvider provider;

    @Test
    @DisplayName("returns INCOME_CATEGORY_TREND as the supported widget type")
    void getSupportedType_returnsIncomeCategoryTrend() {
        assertThat(provider.getSupportedType()).isEqualTo(StatisticsWidgetType.INCOME_CATEGORY_TREND);
    }
    ...
    void getData_withResults() {
        ...
        SeriesPayload expected = new SeriesPayload(StatisticsWidgetType.INCOME_CATEGORY_TREND, List.of());

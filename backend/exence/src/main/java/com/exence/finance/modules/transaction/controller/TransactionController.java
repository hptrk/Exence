...
public interface TransactionController {
    ...
    ResponseEntity<PageResponse<TransactionDTO>> getRecurringTransactions(Pageable pageable);

    ResponseEntity<PageResponse<TransactionDTO>> getIncomes(TransactionFilter filter, Pageable pageable);

    ResponseEntity<PageResponse<TransactionDTO>> getRecurringIncomes(Pageable pageable);

    ResponseEntity<PageResponse<TransactionDTO>> getExpenses(TransactionFilter filter, Pageable pageable);

    ResponseEntity<PageResponse<TransactionDTO>> getRecurringExpenses(Pageable pageable);

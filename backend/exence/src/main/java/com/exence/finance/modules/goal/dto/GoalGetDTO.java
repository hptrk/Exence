...
public record GoalGetDTO(
        ...
        @Schema(description = "Target amount converted to the user's base currency.", example = "1200000.00")
                BigDecimal targetBaseCurrencyAmount,
        @Schema(
                        description = "Current amount saved towards the goal, converted to the user's base currency.",
                        example = "400000.00")

...
// This class is a filter class, runs before every http request, checks if the request has a valid ACCESS JWT token, and sets the security context if the token is valid
@Component

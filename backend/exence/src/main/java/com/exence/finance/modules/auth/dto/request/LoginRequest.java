...
@Schema(title = "Login Request DTO", description = "Used for user authentication.")
public record LoginRequest(
        @Schema(
                        description =
                                "The email address associated with the user account. Must be in a valid email format.",
        ...
        @Schema(
                        description =
                                "The password for the user account. This is used to authenticate the user during login.",
                        example = "Password123!")

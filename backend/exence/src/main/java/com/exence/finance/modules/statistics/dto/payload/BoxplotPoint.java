...
public record BoxplotPoint(
        ...
        @Schema(
                        description =
                                "A list of numerical values representing the data points for the boxplot. The list should"
        ...
        @Schema(
                        description =
                                "The color of the boxplot point. This can be used to differentiate between for example"

...
public record StatCardPayload(
        @Schema(example = "TOP_EXPENSE_TRANSACTION_STATCARD")
        WidgetType type,
        ...
        @Schema(
                description = "A descriptive label providing context for the statistic, such as 'Total Expenses' or 'No"
                        + " Spend Days'.",
        ...
        @Schema(
                description = "The trend direction based on the change percentage, indicating whether the value has"

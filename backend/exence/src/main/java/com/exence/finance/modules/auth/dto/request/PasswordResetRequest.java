...
@Schema(
    ...
    description = "DTO for resetting a user's password using a valid reset token.")
@PasswordMatches(password = "newPassword", confirmPassword = "confirmNewPassword")
public record PasswordResetRequest(
        @Schema(
            description = "The password reset token sent to the user's email address. This token verifies the user's"

...
@Schema(title = "Device Session DTO", description = "Used for retrieving device session details.")
public record DeviceSessionDTO(
        @Schema(description = "Unique identifier of the session.", example = "36822711-3390-4a4a-8210-9704ad1116ba")
                String sessionId,
        @Schema(description = "Name of the device used for the session", example = "Winston's iPhone")
                String deviceName,
        @Schema(description = "Browser used for the session", example = "Safari 16.4") String browser,

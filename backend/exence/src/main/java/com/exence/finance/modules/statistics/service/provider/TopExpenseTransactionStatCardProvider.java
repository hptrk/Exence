...
public final class TopExpenseTransactionStatCardProvider implements WidgetDataProvider {
    ...
    public StatCardPayload getData(WidgetRequest request) {
        ...
        TrendResult trend = ProviderHelper.computeTrend(request, current.getAmount(), (s, e) -> {
            TopTransactionProjection prev =
                    transactionRepository.findTopTransactionByType(s, e, TransactionType.EXPENSE);
